...
- **`docs/index.html`** — single-page control UI, with all **549 MoonBoard 2016
  ...
  index 0 and doesn't light - and uses green then red, because an isolated
  blue hold makes the box light the next index red as well. The page is search-and-light only; log your sends in
